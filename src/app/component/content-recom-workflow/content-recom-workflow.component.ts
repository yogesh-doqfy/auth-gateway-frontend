...
import { NgFlowchartCanvasDirective } from '@joelwenzel/ng-flowchart';
import { MessagesService } from 'src/app/services/messages.service';
import { UserService } from 'src/app/services/user.service';
import { WebflowService } from 'src/app/services/webflow.service';

@Component({
  selector: 'app-content-recom-workflow',
  templateUrl: './content-recom-workflow.component.html',
  styleUrls: ['./content-recom-workflow.component.scss', './mobile.scss']
})
export class ContentRecomWorkflowComponent implements OnInit {
  ...
  // @ViewChild('workflowRecomContainer') containerRef!: ElementRef; 
